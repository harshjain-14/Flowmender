...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-4xl mx-4 shadow-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-6 sm:p-8">
                ...
                >
                  {plan.popular && (
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                      <span className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-medium flex items-center">
                  ...
                  <div className="text-center mb-4 sm:mb-6">
                    ...
                    {savings.percentage > 0 && (
                      <div className="mt-2 text-green-600 text-xs sm:text-sm font-medium">
          ...
          <div className="bg-gray-50 rounded-lg p-4 sm:p-6 mb-6">
            <h4 className="font-semibold text-gray-900 mb-3 text-sm sm:text-base">What you get with every analysis:</h4>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 flex items-center justify-center bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 sm:py-4 px-4 sm:px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm sm:text-lg"
            >
              {loading ? (
                <>
            ...
            <button
              onClick={onClose}
              className="px-4 sm:px-6 py-3 sm:py-4 text-gray-600 hover:text-gray-700 font-medium transition-colors text-sm sm:text-base"
            >
              Cancel
            </button>
          </div>
